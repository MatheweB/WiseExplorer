...
def render_debug(
    ...
    *,
    ...
    output.append(f"{BOLD}║                      MOVE ANALYSIS SUMMARY                        ║{RESET}")
    output.append(f"{BOLD}╚═══════════════════════════════════════════════════════════════════╝{RESET}")
    output.append("")
    ...
    sep_length = sum([W_MOVE, 1, W_STAT*4+3, 1, W_METRIC*3+W_TOTAL+3, 1, 
                      W_OPP_MOVE, W_OPP_STAT*4+3, W_OPP_METRIC*2+1, 1, 20])
    ...
    output.append("")
    output.append(f"{DIM}Legend: ★=Best Move, 🔥=Dangerous, ↓=Risk-Adjusted, 👁=Opponent Data{RESET}")
    output.append("")
    ...
    output.append(f"{BOLD}╔═══════════════════════════════════════════════════════════════════╗{RESET}")
    output.append(f"{BOLD}║                       HEATMAP VISUALIZER                          ║{RESET}")
    output.append(f"{BOLD}╚═══════════════════════════════════════════════════════════════════╝{RESET}")
    output.append("")
